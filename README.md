...
![Committs](https://img.shields.io/github/commit-activity/m/hagabbar/VItamin)
...
In the demo below, we initiate training using 1,000 training samples and 
256 testing samples (r=16). For better results, it is recommended that 
you perform ~1e6 training iterations using ~1e6 training samples.

<img src="training_VItamin.gif" alt="train" title="train" align="left" height="" />
...
In the demo below we are generating plots using 256 testing 
